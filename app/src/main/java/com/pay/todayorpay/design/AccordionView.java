  ...
  protected void onFinishInflate() {
    ...
    for (int i = 0; i < childCount; i++) {
      ...
      if(sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
        section.setBackgroundDrawable(ContextCompat.getDrawable(getContext(), R.drawable.dark_background) );
      } else {
        section.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.dark_background));
      }

      section.setPadding(0,5,0,5);
