...
//        setFont();
    ...
    public void setFont() {
        Typeface myFont = Typeface.createFromAsset(context.getAssets(), "font/OptimusPrincepsSemiBold.ttf");
        setTypeface(myFont);
    }
    @Override
...
//            Typeface myFont = Typeface.createFromAsset(context.getAssets(), "font/MyriadPro-Regular.otf");
            Typeface myFont = Typeface.createFromAsset(context.getAssets(), "font/AvenirLTStd-Book.otf");
            setTypeface(myFont);
        }
        catch (Exception e) {
        }
